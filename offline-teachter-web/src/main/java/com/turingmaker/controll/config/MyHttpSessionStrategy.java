...
import com.turingmaker.controll.controllers.TeachterClassController;
...
public class MyHttpSessionStrategy implements HttpSessionStrategy {
	 ...
	 * 设置cookiename
	 */
	private final String cookieName = "offline-turing-token-operation";
	...
	public void onNewSession(Session session, HttpServletRequest request, HttpServletResponse response) {
		...
		if(logger.isDebugEnabled()) {
			logger.debug("新的会话设置 会话id" + session.getId() + "url:" + request.getRequestURI());
		}
